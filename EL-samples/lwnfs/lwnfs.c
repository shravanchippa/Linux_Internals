...
//BRS		ret->i_blksize = PAGE_CACHE_SIZE;
		ret->i_blocks = 0;
...
{
//BRS	filp->private_data = inode->u.generic_ip;
...
//BRS	inode->u.generic_ip = counter;
...
static struct super_block *lfs_get_super(struct file_system_type *fst,
		int flags, char *devname, void *data, struct vfsmount *mnt)
{
